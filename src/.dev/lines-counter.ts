...
const files = [
	...
	"datasource/entity/Admin_Rota.ts",
	"datasource/entity/Admin.ts",
	"datasource/entity/Feedback.ts",
	"datasource/entity/Partida.ts",
	"datasource/entity/Ponto.ts",
	"datasource/entity/Rota_Ponto.ts",
	"datasource/entity/Rota.ts",
];
